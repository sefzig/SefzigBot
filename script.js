 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--UBER")) { versuch = true; return bot.say(+'  ').then(() => 'strategie'); }if  (~befehl.indexOf("--ÜBER")) { versuch = true; return bot.say(+'  ').then(() => 'strategie'); }if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(+'  ').then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(+'  ').then(() => 'strategie'); }          
       // -----------------
       // Inhalte
       // -----------------
