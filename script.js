    ...
    empfang: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--LEISTUNG")) { versuch = true; return bot.say(BeratungsBot+' Wir möchten Sie in Sachen Chatbots --beraten. Gerne können wir auch operativ --mitarbeiten. ').then(() => bot.say(BeratungsBot+' Dabei bringen wir unsere bestehenden --Lösungen mit, die wir als Teil unserer Leistungen (ohne Zusatzkosten!) einbringen. ')).then(() => bot.say(BeratungsBot+' Kein Interesse? Dann lassen Sie zurück zur --Beratung gehen. ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--MITARBEIT")) { versuch = true; return bot.say(BeratungsBot+' Gerne leihen wir Ihnen Andreas als Freelancer! Er hat praktische Erfahrung in allen Gewerken einer Kommunikations-Agentur und begleitet Ihr Bot-Projekt von der Zieldefinition bis zum Livegang. ').then(() => bot.say(BeratungsBot+' Hier finden Sie Konditionen und Details: [Text:Robogeddon Mitarbeit,RobogeddonMitarbeit] ')).then(() => bot.say(BeratungsBot+' Oder wollen Sie mit mir über unsere anderen --Leistungen sprechen? ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--BERATE")) { versuch = true; return bot.say(BeratungsBot+' Gerne begleiten wir Sie auf Ihrem Weg ins Robogeddon - greifen Sie auf unsere Expertise in der Strategie, Konzeption und Technologie von Chat-Bots zurück! ').then(() => bot.say(BeratungsBot+' Hier finden Sie Konditionen und Details: [Text:Robogeddon Beratung,RobogeddonBeratung] ')).then(() => bot.say(BeratungsBot+' Oder sprechen Sie mit mir über unsere anderen --Leistungen. ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--EINFÜHRUNG")) { versuch = true; return bot.say(BeratungsBot+' Sie wollen Ihre interne Kommunikation auf Chat umstellen? Ein kluger Zug! ').then(() => bot.say(BeratungsBot+' Dann sollten Sie uns ansprechen: Wir haben nicht nur Erfahrung mit ChatOps und kennen die kulturellen Stolpersteine - wir haben auch eine Reihe praktischer --Lösungen entwickelt, mit denen Sie Ihre Mitarbeiter elegant ins Thema holen! ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie mich Ihnen unsere anderen --Leistungen zeigen. ')).then(() => 'beratung');}if (~befehl.indexOf("--EINFUHRUNG")) { versuch = true; return bot.say(BeratungsBot+' Sie wollen Ihre interne Kommunikation auf Chat umstellen? Ein kluger Zug! ').then(() => bot.say(BeratungsBot+' Dann sollten Sie uns ansprechen: Wir haben nicht nur Erfahrung mit ChatOps und kennen die kulturellen Stolpersteine - wir haben auch eine Reihe praktischer --Lösungen entwickelt, mit denen Sie Ihre Mitarbeiter elegant ins Thema holen! ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie mich Ihnen unsere anderen --Leistungen zeigen. ')).then(() => 'beratung');}	       
       // -----------------
       // Slack
       // -----------------
          
          if (~befehl.indexOf("--SLACK-ARTIKEL")) { versuch = true; return bot.say(BeratungsBot+' Andreas hat einen fundierten Artikel zu --Slack geschrieben: Was müssen Marketer über Slack wissen? [Text:Artikel: Slack,SefzignetSlack] ').then(() => 'beratung');}          
          if (~befehl.indexOf("--SLACK-BLOGPOST")) { versuch = true; return bot.say(BeratungsBot+' Lesen Sie auch unseren Blogpost zu --Slack: Was ist Slack und wie nutzt man es? [Text:Blogpost: Slack,SefzignetBlogSlack] ').then(() => 'beratung');}          
          ...
          if (~befehl.indexOf("--SLACK")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere Inhalte zu Slack ans Herz legen: Ein --Slack-Blogpost zeigt die Einfachheit der Anwendung. Ein --Slack-Artikel zeigt die Bedeutung für Marketer. Öffnen Sie unsere --Slack-Links oder treten Sie unserem --Slack-Team bei. ').then(() => 'beratung');}          
       // -----------------
       // Vorlagen
       // -----------------
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Ach ja, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
