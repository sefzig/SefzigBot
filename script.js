 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--NUTZUNG")) { versuch = true; return bot.say(KonzeptionsBot+' Nutzung Text 1. ').then(() => bot.say(KonzeptionsBot+' Nutzung Text 2. ')).then(() => bot.say(KonzeptionsBot+' Zurück zur --Strategie. ')).then(() => 'konzeption');}          if (~befehl.indexOf("--CHAT")) { versuch = true; return bot.say(KonzeptionsBot+' Chats Text 1. ').then(() => bot.say(KonzeptionsBot+' Chats Text 2. ')).then(() => bot.say(KonzeptionsBot+' Zurück zur --Strategie. ')).then(() => 'konzeption');}          if (~befehl.indexOf("--PLATTFORM")) { versuch = true; return bot.say(KonzeptionsBot+' Plattform Text 1. ').then(() => bot.say(KonzeptionsBot+' Plattform Text 2. ')).then(() => bot.say(KonzeptionsBot+' Zurück zur --Strategie. ')).then(() => 'konzeption');}          
