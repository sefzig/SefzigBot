    ...
    register: {
        ...
        receive: (bot, message) => {
         ...
         // -----------------
            ...
            if  (~befehl.indexOf("--INTERN"))         { versuch = true; bot.say(SefzigBot+'Es lohnt sich, die interne Kommunikation auf Chat umzustellen - zeigt u.a. eine --Studie von Slack und wir können das bestätigen.').then(function(){
                                                                 ...
                                                                 return bot.say(SefzigBot+'Mit den Prinzipien der --ChatOps in Ihrer --Strategie erleichtern Sie Ihrem Team die Arbeit immens!'); }); }
            ...
            if  (~befehl.indexOf("--STUDIE"))         { versuch = true; bot.say(SefzigBot+'Slack hat im Juli 2015 eine Studie durchgeführt: [Button:Studie von Slack,http://slack.com/results] ').then(function(){
                                                                 return bot.say(SefzigBot+'Nach eigenen Angaben haben Teams einen Produktivitäts-Gewinn von bis zu 32% durch den Einsatz von Slack, 80% sehen mehr Transparenz und fast 50% weniger Emails.') }).then(function(){
