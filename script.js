    ...
    empfang: {
       ...
       // -----------------
          ...
          if (dann != "strategie") { 
   		    ...
   		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(StrategieBot+' Hi, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ').then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(StrategieBot+' Hi, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ').then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }          }
