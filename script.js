 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--PRODUKTE")) { versuch = true; return bot.say(EmpfangsBot+' #Robogeddon sind Andreas Sefzig und freie Mitarbeiter, eine Handvoll Marketing-Technologien und wir Bots. ').then(() => bot.say(EmpfangsBot+' Wir realisieren Chat-Bots für die --interne und --externe Unternehmens-Kommunikation. ')).then(() => bot.say(EmpfangsBot+' Wir befinden uns in einem sehr jungen Markt. Lassen Sie sich von uns beraten, warum und wie Sie Ihren Bot haben wollen! ')).then(() => bot.say(EmpfangsBot+' Lassen Sie uns über die --Strategie oder --Konzeption Ihres eigenen Chat-Bots sprechen! ')).then(() => 'empfang'); }	       
       // -----------------
       // Vorlage (Gewerk, Name)
       // -----------------
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Doris. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Doris. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }		    
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--PRODUKTE")) { versuch = true; return bot.say(BeratungsBot+' #Robogeddon sind Andreas Sefzig und freie Mitarbeiter, eine Handvoll Marketing-Technologien und wir Bots. ').then(() => bot.say(BeratungsBot+' Wir realisieren Chat-Bots für die --interne und --externe Unternehmens-Kommunikation. ')).then(() => bot.say(BeratungsBot+' Wir befinden uns in einem sehr jungen Markt. Lassen Sie sich von uns beraten, warum und wie Sie Ihren Bot haben wollen! ')).then(() => bot.say(BeratungsBot+' Lassen Sie uns über die --Strategie oder --Konzeption Ihres eigenen Chat-Bots sprechen! ')).then(() => 'beratung'); }	       
       // -----------------
       // Vorlage (Gewerk, Name)
       // -----------------
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Doris. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Doris. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }		    
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--PRODUKTE")) { versuch = true; return bot.say(TechnikBot+' #Robogeddon sind Andreas Sefzig und freie Mitarbeiter, eine Handvoll Marketing-Technologien und wir Bots. ').then(() => bot.say(TechnikBot+' Wir realisieren Chat-Bots für die --interne und --externe Unternehmens-Kommunikation. ')).then(() => bot.say(TechnikBot+' Wir befinden uns in einem sehr jungen Markt. Lassen Sie sich von uns beraten, warum und wie Sie Ihren Bot haben wollen! ')).then(() => bot.say(TechnikBot+' Lassen Sie uns über die --Strategie oder --Konzeption Ihres eigenen Chat-Bots sprechen! ')).then(() => 'technik'); }	       
       // -----------------
       // Vorlage (Gewerk, Name)
       // -----------------
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Doris. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Doris. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }		    
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--PRODUKTE")) { versuch = true; return bot.say(KreationsBot+' #Robogeddon sind Andreas Sefzig und freie Mitarbeiter, eine Handvoll Marketing-Technologien und wir Bots. ').then(() => bot.say(KreationsBot+' Wir realisieren Chat-Bots für die --interne und --externe Unternehmens-Kommunikation. ')).then(() => bot.say(KreationsBot+' Wir befinden uns in einem sehr jungen Markt. Lassen Sie sich von uns beraten, warum und wie Sie Ihren Bot haben wollen! ')).then(() => bot.say(KreationsBot+' Lassen Sie uns über die --Strategie oder --Konzeption Ihres eigenen Chat-Bots sprechen! ')).then(() => 'kreation'); }	       
       // -----------------
       // Vorlage (Gewerk, Name)
       // -----------------
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--PRODUKTE")) { versuch = true; return bot.say(KonzeptionsBot+' #Robogeddon sind Andreas Sefzig und freie Mitarbeiter, eine Handvoll Marketing-Technologien und wir Bots. ').then(() => bot.say(KonzeptionsBot+' Wir realisieren Chat-Bots für die --interne und --externe Unternehmens-Kommunikation. ')).then(() => bot.say(KonzeptionsBot+' Wir befinden uns in einem sehr jungen Markt. Lassen Sie sich von uns beraten, warum und wie Sie Ihren Bot haben wollen! ')).then(() => bot.say(KonzeptionsBot+' Lassen Sie uns über die --Strategie oder --Konzeption Ihres eigenen Chat-Bots sprechen! ')).then(() => 'konzeption'); }	       
       // -----------------
       // Vorlage (Gewerk, Name)
       // -----------------
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Doris. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Doris. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 2: Befehle: --Leben, --Dialoge, --Persönlichkeit, --Geschichten, --Inhalte, --Mehrwerte. ')).then(() => bot.say(KreationsBot+' Hallo Kreation Text 3. ')).then(() => 'kreation'); }		    
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--PRODUKTE")) { versuch = true; return bot.say(StrategieBot+' #Robogeddon sind Andreas Sefzig und freie Mitarbeiter, eine Handvoll Marketing-Technologien und wir Bots. ').then(() => bot.say(StrategieBot+' Wir realisieren Chat-Bots für die --interne und --externe Unternehmens-Kommunikation. ')).then(() => bot.say(StrategieBot+' Wir befinden uns in einem sehr jungen Markt. Lassen Sie sich von uns beraten, warum und wie Sie Ihren Bot haben wollen! ')).then(() => bot.say(StrategieBot+' Lassen Sie uns über die --Strategie oder --Konzeption Ihres eigenen Chat-Bots sprechen! ')).then(() => 'strategie'); }	       
       // -----------------
       // Vorlage (Gewerk, Name)
       // -----------------
