 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--UBER")) { versuch = true; return bot.say(StrategieBot+' Chat-Bots gibt es schon --lange. Sie werden plötzlich interessant, da nun alle 'modernen' Menschen mobil und mit Chatten vertraut sind und sich die großen --Plattformen wie Facebook Messenger für Bots öffnen. ').then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--üBER")) { versuch = true; return bot.say(StrategieBot+' Chat-Bots gibt es schon --lange. Sie werden plötzlich interessant, da nun alle 'modernen' Menschen mobil und mit Chatten vertraut sind und sich die großen --Plattformen wie Facebook Messenger für Bots öffnen. ').then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(StrategieBot+' Chat-Bots gibt es schon --lange. Sie werden plötzlich interessant, da nun alle 'modernen' Menschen mobil und mit Chatten vertraut sind und sich die großen --Plattformen wie Facebook Messenger für Bots öffnen. ').then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(StrategieBot+' Chat-Bots gibt es schon --lange. Sie werden plötzlich interessant, da nun alle 'modernen' Menschen mobil und mit Chatten vertraut sind und sich die großen --Plattformen wie Facebook Messenger für Bots öffnen. ').then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }          
       // -----------------
       // Inhalte
       // -----------------
