    ...
    register: {
        receive: (bot, message) => {
         ...
         // -----------------
            ...
            if (befehl == "--KONTAKT")        { bot.say(SefzigBot+'Andreas E-Mail-Adresse: [Button:andreas@sefzig.net,mailto:andreas@sefzig.net] Seine mobile Telefonnummer: [Button:0151 15 92 00 82,tel:+4915115920082] Kontaktseite: [Text:Kontakt]');
