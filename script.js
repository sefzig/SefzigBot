    ...
    empfang: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--LEISTUNG")) { versuch = true; return bot.say(BeratungsBot+' Andreas kann Sie in Sachen Chatbots --beraten. Er kann sicherlich auch operativ an Ihrem Projekt --mitarbeiten. ').then(() => bot.say(BeratungsBot+' Nutzen Sie seine Erfahrung bei der --Einführung von Chats und Chat-Bots. Nach Bedarf bringt er unsere bestehenden --Lösungen kostenlos ein! ')).then(() => bot.say(BeratungsBot+' Kein Interesse? Dann lassen Sie zurück zur --Beratung gehen. ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--MITARBEIT")) { versuch = true; return bot.say(BeratungsBot+' Gerne leihen wir Ihnen Andreas als Freelancer! Er hat praktische Erfahrung in allen Gewerken einer Kommunikations-Agentur und begleitet Ihr Bot-Projekt von der Zieldefinition bis zum Livegang. ').then(() => bot.say(BeratungsBot+' Die Konditionen und Details: [Text:Robogeddon Mitarbeit,RobogeddonMitarbeit] ')).then(() => bot.say(BeratungsBot+' Oder wollen Sie mit mir über unsere anderen --Leistungen sprechen? ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--BERATE")) { versuch = true; return bot.say(BeratungsBot+' Gerne begleiten wir Sie auf Ihrem Weg ins Robogeddon :D Greifen Sie auf unsere Expertise in Strategie, Konzeption und Technologie zurück! ').then(() => bot.say(BeratungsBot+' Hier finden Sie Konditionen und Details: [Text:Robogeddon Beratung,RobogeddonBeratung] ')).then(() => bot.say(BeratungsBot+' Oder sprechen Sie mit mir über unsere anderen --Leistungen. ')).then(() => 'beratung');}	       
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--LÖSUNG")) { versuch = true; return bot.say(BeratungsBot+' Wir bieten Ihnen elegante Chatbot-Lösungen für Ihre externe und interne Kommunikation an. Unser Flagschiff ist der #Robogeddon --Chatraum - die Luxus-Variante für extern. Für intern haben wir verschiedene Werkzeuge, die Ihre --ChatOps einfach machen. ').then(() => bot.say(BeratungsBot+' Unsere bereits entwickelten Lösungen stehen Ihnen als Teil unserer --Leistungen sogar kostenlos zur Verfügung! ')).then(() => bot.say(BeratungsBot+' Oder wollen wir zurück zur --Beratung gehen? ')).then(() => 'beratung');}if (~befehl.indexOf("--LOSUNG")) { versuch = true; return bot.say(BeratungsBot+' Wir bieten Ihnen elegante Chatbot-Lösungen für Ihre externe und interne Kommunikation an. Unser Flagschiff ist der #Robogeddon --Chatraum - die Luxus-Variante für extern. Für intern haben wir verschiedene Werkzeuge, die Ihre --ChatOps einfach machen. ').then(() => bot.say(BeratungsBot+' Unsere bereits entwickelten Lösungen stehen Ihnen als Teil unserer --Leistungen sogar kostenlos zur Verfügung! ')).then(() => bot.say(BeratungsBot+' Oder wollen wir zurück zur --Beratung gehen? ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--CHATRAUM")) { versuch = true; return bot.say(BeratungsBot+' Sie befinden sich gerade in einem #Robogeddon-Chatraum! Die Lösung ist perfekt für die 1-zu-1-Kommunikation mit einzelnen Personen - Webseite, Content-Kanal und CRM in einem. ').then(() => bot.say(BeratungsBot+' Mehr über diese --Lösung: [Text:Produktbeschreibung,RobogeddonChatraum] ')).then(() => bot.say(BeratungsBot+' Oder wollen wir über die anderen --Lösungen sprechen? ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--CHATOP")) { versuch = true; return bot.say(BeratungsBot+' Mit ChatOps steuern und beschleunigen Sie die Kommunikation in Ihrem Team. Immens. Unsere Lösungen geben Ihrem Team den Zugriff auf Ihre Daten, erlauben das Steuern Ihrer Marketing-Technologien und ermöglichen Ihnen die Readktion Ihrer internen Inhalte. ').then(() => bot.say(BeratungsBot+' Für die Datenverarbeitung im Chat haben Sie unsere --Bots. Für Ihre interne Push-Kommunikation haben Sie unseren --Redaktionsplan. ')).then(() => bot.say(BeratungsBot+' Oder wollen Sie zu den anderen --Lösungen? ')).then(() => 'beratung');}	       
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--ARTIKEL")) { versuch = true; return bot.say(BeratungsBot+' Andreas hat einen fundierten Artikel zu --Slack geschrieben: Was müssen Marketer über Slack wissen? [Text:Artikel: Slack,RobogeddonSlackArtikel] ').then(() => bot.say(BeratungsBot+' Zu --Slack oder zur --Beratung? ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--BLOGPOST")) { versuch = true; return bot.say(BeratungsBot+' Lesen Sie auch unseren Blogpost zu --Slack: Was ist Slack und wie nutzt man es? [Text:Blogpost: Slack,SefzignetBlogSlack] ').then(() => bot.say(BeratungsBot+' Zu --Slack oder zur --Beratung? ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--LINKLISTEN")) { versuch = true; return bot.say(BeratungsBot+' Wir haben uns viele wichtige Artikel zu --Slack gemerkt: [Linkliste:Linkliste Slack-Artikel,Slack:Artikel] ').then(() => bot.say(BeratungsBot+' Zu --Slack oder zur --Beratung? ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--TEAM")) { versuch = true; return bot.say(BeratungsBot+' Treten Sie unserem offenen --Slack Team  bei, um sich mit uns auszutauschen: [Button:Anmeldung,http://sefzig.net/link/SlackAnmeldung/] ').then(() => bot.say(BeratungsBot+' Zu --Slack oder zur --Beratung? ')).then(() => 'beratung');}          
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // Intern
          if (~befehl.indexOf("--INTERN")) { versuch = true; return bot.say(StrategieBot+' Die Erfahrung und eine --Studie von Slack zeigen, dass es sich lohnt, die interne Kommunikation auf Chat umzustellen. ').then(() => bot.say(StrategieBot+' Wenn Ihr Team dann schon den ganzen Tag einen Chat-Client nutzt, können Sie über Erweiterungen und Bots viele interne und externe --Daten in die Konversation holen. ')).then(() => bot.say(StrategieBot+' Mit den Prinzipien der ChatOps als Teil Ihrer --Strategie können Sie Ihrem --Team die Arbeit immens erleichtern! ')).then(() => 'strategie');}          if (~befehl.indexOf("--TEAM")) { versuch = true; return bot.say(StrategieBot+' Team Text 1. ').then(() => bot.say(StrategieBot+' Team Text 2. ')).then(() => bot.say(StrategieBot+' Zurück zu --Strategie --intern. ')).then(() => 'strategie');}          if (~befehl.indexOf("--DATEN")) { versuch = true; return bot.say(StrategieBot+' Mit Bots und Erweiterungen geben Sie Ihrem Team rollen-basierten Zugriff auf diverse Daten-Quellen und Marketing-Technologien, deren Daten aufgrund der Natur des Chats immer nur ein, zwei Wörter weit entfernt sind. ').then(() => bot.say(StrategieBot+' Viele Erweiterungen, z.B. von Slack, erlauben auch die (eingeschränkte) Steuerung von Diensten wie Jira, Skype oder Mailchimp. ')).then(() => bot.say(StrategieBot+' Daten in Konversationen haben zudem einen --intern lehrreichen Charakter: Man sieht im Chat, wie die Kollegen Daten abfragen und Ihre Werkzeuge steuern. Gut für Ihre --Strategie! ')).then(() => 'strategie');}          if (~befehl.indexOf("--STUDIE")) { versuch = true; return bot.say(StrategieBot+' Der führende Chat-Anbieter Slack hat im Juli 2015 eine Studie durchgeführt: [Button:Studie von Slack,http://slack.com/results] ').then(() => bot.say(TechnikBot+' Wir in der Technik setzen --intern als --Team auf ChatOps und stellen fest: Wir kommunizieren schriftlich zu 100% über --Slack und steuern unsere Marketing-Technologien zu 80% im Chat. ')).then(() => bot.say(StrategieBot+' Nach eigenen Angaben haben Teams einen Produktivitäts-Gewinn von bis zu 32% durch den Einsatz von Slack, 80% sehen mehr Transparenz und fast 50% weniger Emails. ')).then(() => 'strategie');}          
       // Extern
