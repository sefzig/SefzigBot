    ...
    empfang: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Doris. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Doris. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }		    
		    ...
		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Feline. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Feline. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }
       // -----------------
       // Über uns
       // -----------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Doris. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Doris. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }		    
		    ...
		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Feline. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Feline. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }
       // -----------------
       // Über uns
       // -----------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Doris. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Doris. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }		    
		    ...
		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Feline. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Feline. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }
       // -----------------
       // Über uns
       // -----------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Doris. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Doris. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }		    
		    ...
		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Feline. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Feline. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }
       // -----------------
       // Über uns
       // -----------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Doris. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Doris. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }		    
		    ...
		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Feline. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Feline. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }
       // -----------------
       // Über uns
       // -----------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Doris. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Doris. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ')).then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }		    
		    ...
		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Feline. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Feline. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ')).then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich eher für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }
       // -----------------
       // Über uns
       // -----------------
