 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'empfang');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'beratung');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'technik');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'kreation');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'konzeption');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'strategie');}	       
       // -----------------
       // Funktionen
       // -----------------
