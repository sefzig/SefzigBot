       ...
       // Nächster Schritt default
          ...
          // bot.say(EmpfangsBot+'Ich leite Sie weiter.');
             ...
             if (bekannt == false) {
                                ...
                                return bot.say(EmpfangsBot+' Wir sind --Robogeddon, eine Agentur für (und aus) Chat-Bots. ').then(() => bot.say(EmpfangsBot+' Unterhalten Sie sich mit uns, indem sie die die farbig hinterlegten Wörter sagen (also schreiben, klicken oder berühren): ')).then(() => bot.say(EmpfangsBot+' Sprechen Sie mit meinen Kolleginnen aus --Beratung, --Kreation, --Konzeption, --Strategie und --Technik über das Chatten in der Unternehmens-Kommunikation! ')).then(() => bot.say(EmpfangsBot+' Ich habe rechts das Menü für Sie geöffnet. Sie können es mit dem Button oben rechts bedienen - oder indem Sie --Menü schreiben. [Javascript:menu(an)] ')).then(() => 'empfang');                
             }
             else {
 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. Das wird schon noch :D Viel Spass! ')).then(() => bot.say(SefzigBot+' Starte mit --Empfang oder --Menü. ')).then(() => 'empfang');}	       
       // -----------------
       // Funktionen
       // -----------------
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
          
          if (zuletzt_klein != "technik") { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Cynthia. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Cynthia. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');} } else { 
          ...
          if (zuletzt_klein != "konzeption") { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Erika. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Erika. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');} } else { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}          }
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
          
          if (zuletzt_klein != "technik") { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Cynthia. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Cynthia. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');} } else { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}          }
          ...
          if (zuletzt_klein != "konzeption") { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Erika. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Erika. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');} } else { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--CHATRAUM")) { versuch = true; return bot.say(BeratungsBot+' Sie befinden sich gerade in einem #Robogeddon-Chatraum! Die Lösung ist perfekt für die 1-zu-1-Kommunikation mit einzelnen Personen. ').then(() => bot.say(BeratungsBot+' Webseite, Content und CRM in einem: [Text:Produktbeschreibung,RobogeddonChatraum] ')).then(() => bot.say(BeratungsBot+' Oder wollen wir über die anderen --Lösungen sprechen? ')).then(() => 'beratung');}	       
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
          
          if (zuletzt_klein != "technik") { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Cynthia. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Cynthia. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');} } else { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}          }
          ...
          if (zuletzt_klein != "konzeption") { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Erika. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Erika. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');} } else { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}          }
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
          
          if (zuletzt_klein != "technik") { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Cynthia. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Cynthia. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');} } else { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}          }
          ...
          if (zuletzt_klein != "konzeption") { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Erika. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Erika. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');} } else { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}          }
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
          
          if (zuletzt_klein != "technik") { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Cynthia. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Cynthia. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');} } else { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BEFEHLE")) { versuch = true; return bot.say(KonzeptionsBot+' Text Konzeption Befehle: --Kanäle. ').then(() => bot.say(KonzeptionsBot+' --Nutzen des Chats: --Chat, --Daten, --Plattformen. ')).then(() => 'konzeption');}if (~befehl.indexOf("--BEFEHL")) { versuch = true; return bot.say(KonzeptionsBot+' Text Konzeption Befehle: --Kanäle. ').then(() => bot.say(KonzeptionsBot+' --Nutzen des Chats: --Chat, --Daten, --Plattformen. ')).then(() => 'konzeption');}
          if (~befehl.indexOf("--UBER")) { versuch = true; return bot.say(KonzeptionsBot+' Ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(BeratungsBot+' 90% der Fehler werden in den ersten 10% des Projekts gemacht. Nicht bei uns - dank Erika! ')).then(() => bot.say(KonzeptionsBot+' Ich kenne den --Nutzen von --Chats und alle --Plattformen. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ÜBER")) { versuch = true; return bot.say(KonzeptionsBot+' Ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(BeratungsBot+' 90% der Fehler werden in den ersten 10% des Projekts gemacht. Nicht bei uns - dank Erika! ')).then(() => bot.say(KonzeptionsBot+' Ich kenne den --Nutzen von --Chats und alle --Plattformen. ')).then(() => 'konzeption');}          
       // -----------------
       // Kanäle
       // -----------------
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hi, ich bin Barbara, der Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. ')).then(() => bot.say(BeratungsBot+' Oder lassen Sie uns eine --Kalkulation (beta) für Ihren Bot erstellen! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen zeigen. Oder schreiben Sie einen meiner --Befehle. ').then(() => bot.say(BeratungsBot+' Wenn Sie wollen, machen wir gemeinsam eine --Kalkulation (beta) für Ihren Bot! ')).then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
          
          if (zuletzt_klein != "technik") { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Cynthia. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Cynthia. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ')).then(() => bot.say(TechnikBot+' Ich bin gerade sehr beschäftigt - aber Sie könnten mit kurz beim --Testen helfen! ')).then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich noch so kann. ')).then(() => 'technik');} } else { 
   		    if (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}if (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(TechnikBot+' Ich bin immernoch sehr beschäftigt. Mögen Sie mir kurz beim --Testen helfen? ').then(() => bot.say(TechnikBot+' Schreiben Sie --Befehle, um zu sehen was ich bereits automatisiert habe. Oder wollen Sie --abbrechen? ')).then(() => 'technik');}          }
          ...
          if (zuletzt_klein != "konzeption") { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Erika. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Erika. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');} } else { 
   		    if (~befehl.indexOf("--KONZEPTION")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}if (~befehl.indexOf("--ERIKA")) { versuch = true; return bot.say(KonzeptionsBot+' Hallo, ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(KonzeptionsBot+' Konzeption Text 2. ')).then(() => bot.say(KonzeptionsBot+' Konzeption Text 3: --Befehle folgt. ')).then(() => 'konzeption');}          }
