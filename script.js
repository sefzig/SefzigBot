 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(AndreasSefzig+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(AndreasSefzig+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. ')).then(() => bot.say(AndreasSefzig+' Viel Spass :) ')).then(() => 'empfang');}	       
       // -----------------
       // Funktionen
       // -----------------
