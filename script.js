 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Prä-Alpha. Alle Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Viele, aber nicht alle Inhalte stehen, einige Befehle führen ins leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'empfang');}	       
       // -----------------
       // Funktionen
       // -----------------
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BEFEHLE")) { versuch = true; return bot.say(EmpfangsBot+' Sprechen Sie mit unseren Gewerken: --Beratung, Strategie, Konzeption, Kreation, Technik. ').then(() => bot.say(EmpfangsBot+' Hilfs-Funktionen: --Kontakt, --Newsletter, --Mobil und --Über. ')).then(() => 'empfang');}          
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Prä-Alpha. Alle Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Viele, aber nicht alle Inhalte stehen, einige Befehle führen ins leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'beratung');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Prä-Alpha. Alle Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Viele, aber nicht alle Inhalte stehen, einige Befehle führen ins leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'technik');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Prä-Alpha. Alle Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Viele, aber nicht alle Inhalte stehen, einige Befehle führen ins leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'kreation');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Prä-Alpha. Alle Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Viele, aber nicht alle Inhalte stehen, einige Befehle führen ins leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'konzeption');}	       
       // -----------------
       // Funktionen
       // -----------------
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Prä-Alpha. Alle Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Viele, aber nicht alle Inhalte stehen, einige Befehle führen ins leere. ')).then(() => bot.say(SefzigBot+' Viel Spass :) ')).then(() => 'strategie');}	       
       // -----------------
       // Funktionen
       // -----------------
