...
module.exports = new Script({
 ...
 // -------------------------
    ...
    emailadresse: {
        ...
        receive: (bot, message) => {
            emailadresse = message.text;
            return bot.setProp('emailadresse', emailadresse)
                .then(() => bot.say(EmpfangsBot+`Ihre E-Mail-Adresse ist ${emailadresse}, prima. [Javascript:cookies(email,`+emailadresse+`)]`))
