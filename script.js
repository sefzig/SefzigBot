    ...
    empfang: {
       ...
       // -----------------
          ...
          if (zuletzt_klein != "kreation") { 
             ...
             if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(KreationsBot+' Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ').then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(KreationsBot+' Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ').then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }          }
          ...
          if (zuletzt_klein != "strategie") { 
   		    ...
   		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(StrategieBot+' Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ').then(() => bot.say(StrategieBot+' Die --Anwendungsbeispiele für Chat-Bots unterscheiden sich nicht nur inhaltlich, sondern vor allem in ihrer Ausrichtung: --intern für die Kommunikation im Team oder --extern für den Austausch mit den Kunden. ')).then(() => bot.say(StrategieBot+' Sprechen Sie mit der --Technik über die --Plattformen, mit der --Konzeption über --Formate oder der Kreation über die Inhalte, mit denen unsere Bots kommunizieren (können). ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(StrategieBot+' Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ').then(() => bot.say(StrategieBot+' Die --Anwendungsbeispiele für Chat-Bots unterscheiden sich nicht nur inhaltlich, sondern vor allem in ihrer Ausrichtung: --intern für die Kommunikation im Team oder --extern für den Austausch mit den Kunden. ')).then(() => bot.say(StrategieBot+' Sprechen Sie mit der --Technik über die --Plattformen, mit der --Konzeption über --Formate oder der Kreation über die Inhalte, mit denen unsere Bots kommunizieren (können). ')).then(() => 'strategie'); }          }
