 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (zuletzt != "sefzig") { 
             if  (~befehl.indexOf("--SEFZIG")) { versuch = true; return bot.say(EmpfangsBot+' Ich habe Andreas bereits benachrichtigt. ').then(() => bot.say(EmpfangsBot+' Sprechen Sie solange mit mir, indem Sie --Empfang schreiben! ')).then(() => 'empfang'); } } else { 
          ...
          if (zuletzt != "beratung") { 
             ...
             if  (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. ').then(() => bot.say(BeratungsBot+' Hallo Beratung Text 2: --Befehle folgt. ')).then(() => bot.say(BeratungsBot+' Hallo Beratung Text 3. ')).then(() => 'beratung'); }if  (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Hallo, ich bin Barbara, der Beratungs-Bot. ').then(() => bot.say(BeratungsBot+' Hallo Beratung Text 2: --Befehle folgt. ')).then(() => bot.say(BeratungsBot+' Hallo Beratung Text 3. ')).then(() => 'beratung'); }          }
          if (zuletzt != "technik") { 
   		    ...
   		    if  (~befehl.indexOf("--TECHNIK")) { versuch = true; return bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ').then(() => bot.say(TechnikBot+' Hallo Technik Text 2: --Befehle folgt. ')).then(() => bot.say(TechnikBot+' Hallo Technik Text 3. ')).then(() => 'technik'); }if  (~befehl.indexOf("--CYNTHIA")) { versuch = true; return bot.say(TechnikBot+' Hallo, ich bin Cynthia, der Technik-Bot. ').then(() => bot.say(TechnikBot+' Hallo Technik Text 2: --Befehle folgt. ')).then(() => bot.say(TechnikBot+' Hallo Technik Text 3. ')).then(() => 'technik'); }          }
          if (zuletzt != "kreation") { 
             ...
             if  (~befehl.indexOf("--KREATION")) { versuch = true; return bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ').then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }if  (~befehl.indexOf("--DORIS")) { versuch = true; return bot.say(KreationsBot+' Hallo, ich bin Doris, der Kreations-Bot. Ich möchte Ihnen erzählen, wie wir den trockenen, ach so technischen Bots --Leben einhauchen! ').then(() => bot.say(KreationsBot+' Oder wollen Sie sehen, wie reichhaltig unsere --Inhalte und --Formate sind? ')).then(() => bot.say(KreationsBot+' Ihre Entscheidung :D ')).then(() => 'kreation'); }          }
          ...
          if (zuletzt != "strategie") { 
   		    ...
   		    if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ').then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(StrategieBot+' Hallo, ich bin Feline, der Strategie-Bot. Ich möchte Ihnen erklären, warum --Chats ein wichtiger --Trend für das --Marketing sind. ').then(() => bot.say(StrategieBot+' Chats und Chat-Bots sind seit Neustem interessant, da die meisten Leute mit --Plattformen wie Sms, Messenger oder Chat kennen und häufig/gerne nutzen. ')).then(() => bot.say(StrategieBot+' Interessieren Sie sich für Bots, die --intern (z.B. mit Ihrem Team) oder --extern (z.B. mit Ihren Kunden) kommunizieren? ')).then(() => 'strategie'); }          }
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (zuletzt != "sefzig") { 
             if  (~befehl.indexOf("--SEFZIG")) { versuch = true; return bot.say(EmpfangsBot+' Ich habe Andreas bereits benachrichtigt. ').then(() => bot.say(BeratungsBot+' Sprechen Sie solange mit mir, indem Sie --Beratung schreiben! ')).then(() => 'empfang'); } } else { 
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (zuletzt != "sefzig") { 
             if  (~befehl.indexOf("--SEFZIG")) { versuch = true; return bot.say(EmpfangsBot+' Ich habe Andreas bereits benachrichtigt. ').then(() => bot.say(TechnikBot+' Sprechen Sie solange mit mir, indem Sie --Technik schreiben! ')).then(() => 'empfang'); } } else { 
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (zuletzt != "sefzig") { 
             if  (~befehl.indexOf("--SEFZIG")) { versuch = true; return bot.say(EmpfangsBot+' Ich habe Andreas bereits benachrichtigt. ').then(() => bot.say(KreationsBot+' Sprechen Sie solange mit mir, indem Sie --Kreation schreiben! ')).then(() => 'empfang'); } } else { 
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (zuletzt != "sefzig") { 
             if  (~befehl.indexOf("--SEFZIG")) { versuch = true; return bot.say(EmpfangsBot+' Ich habe Andreas bereits benachrichtigt. ').then(() => bot.say(KonzeptionsBot+' Sprechen Sie solange mit mir, indem Sie --Konzeption schreiben! ')).then(() => 'empfang'); } } else { 
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (zuletzt != "sefzig") { 
             if  (~befehl.indexOf("--SEFZIG")) { versuch = true; return bot.say(EmpfangsBot+' Ich habe Andreas bereits benachrichtigt. ').then(() => bot.say(StrategieBot+' Sprechen Sie solange mit mir, indem Sie --Strategie schreiben! ')).then(() => 'empfang'); } } else { 
