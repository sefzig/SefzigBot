 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if  (~befehl.indexOf("--UBER")) { versuch = true; return bot.say(StrategieBot+' Dank ihrer einfachen und direkten Kommunikation sind Chats ein weltweiter --Trend, Tendenz stark zunehmend. ').then(() => bot.say(StrategieBot+' Für das --Marketing sind Chat-Bots ein naheliegender Kanal für den Dialog mit den Menschen. Die Herausforderung ist, Bots nützlich zu machen. ')).then(() => 'strategie'); }if  (~befehl.indexOf("--üBER")) { versuch = true; return bot.say(StrategieBot+' Dank ihrer einfachen und direkten Kommunikation sind Chats ein weltweiter --Trend, Tendenz stark zunehmend. ').then(() => bot.say(StrategieBot+' Für das --Marketing sind Chat-Bots ein naheliegender Kanal für den Dialog mit den Menschen. Die Herausforderung ist, Bots nützlich zu machen. ')).then(() => 'strategie'); }if  (~befehl.indexOf("--STRATEGIE")) { versuch = true; return bot.say(StrategieBot+' Dank ihrer einfachen und direkten Kommunikation sind Chats ein weltweiter --Trend, Tendenz stark zunehmend. ').then(() => bot.say(StrategieBot+' Für das --Marketing sind Chat-Bots ein naheliegender Kanal für den Dialog mit den Menschen. Die Herausforderung ist, Bots nützlich zu machen. ')).then(() => 'strategie'); }if  (~befehl.indexOf("--FELINE")) { versuch = true; return bot.say(StrategieBot+' Dank ihrer einfachen und direkten Kommunikation sind Chats ein weltweiter --Trend, Tendenz stark zunehmend. ').then(() => bot.say(StrategieBot+' Für das --Marketing sind Chat-Bots ein naheliegender Kanal für den Dialog mit den Menschen. Die Herausforderung ist, Bots nützlich zu machen. ')).then(() => 'strategie'); }          
       // -----------------
       // Inhalte
       // -----------------
