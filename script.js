 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BOB")) { versuch = true; return bot.say(SefzigBot+' Hey Bob, ich bin Sefzigs Bot. Freut mich, dass Du Dir die Seite anschaust! ').then(() => bot.say(SefzigBot+' Ich kann nicht anders als Dich zu bitten, hier tief reinzuschauen und rumzuprobieren... Der Stand: Alle Basis-Funktionen wie Empfang, Onboarding und Bots und Dinge wie zurück, abbrechen oder mobil laufen. Einige Inhalte stehen bereits, einige Befehle führen ins Leere. Das wird schon noch :D ')).then(() => bot.say(SefzigBot+' Viel Spass! Starte mit --Empfang oder --Menü. ')).then(() => 'empfang');}	       
       // -----------------
       // Funktionen
       // -----------------
