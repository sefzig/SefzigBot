 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--FORMAT")) { versuch = true; return bot.say(KreationsBot+' Unsere Technik entwickelt ständig neue Inhalts-Formate, mit denen unsere Bots kommunizieren können: [Text:RobogeddonFormate] Darunter --Bilder, --Videos und --Texte. ').then(() => bot.say(KreationsBot+' Unser System ist erweiterbar, so dass wir ständig weitere interaktive --Elemente hinzufügen können. Mit --Widgets wiederum binden wir externe (Ihre?) Funktionen per Iframe in den Chat ein! ')).then(() => 'kreation');}          
          ...
          if (~befehl.indexOf("--WIDGET")) { versuch = true; return bot.say(KreationsBot+' Hier ein Iframe: [Iframe:http://example.com] ').then(() => 'kreation');}          
