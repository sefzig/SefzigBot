 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--FORMAT")) { versuch = true; return bot.say(KreationsBot+' Wir entwickeln ständig neue Inhalts-Formate, mit denen unsere Bots kommunizieren können: [Text:RobogeddonFormate] ').then(() => bot.say(Unsere --Kreation beinhaltet --Bilder und --Videos sowie Buttons für --Texte, --Links und mehr.+'  ')).then(() => bot.say(KreationsBot+' Unser System ist erweiterbar, so dass wir ständig weitere interaktive --Elemente hinzufügen können. Mit --Widgets können Sie sogar externe (Ihre?) Funktionen per Iframe in den Chat einbinden. ')).then(() => 'kreation');}          
